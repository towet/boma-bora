-- Complete Boma Bora Supabase Database Setup (Fixed Version)
-- Created: 2025-05-13
...
-- Grant permissions on individual types (instead of ALL TYPES which isn't supported)
...
BEGIN
  ...
  name_val := COALESCE(new.raw_user_meta_data->>'full_name', 'User');
